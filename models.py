...
class NearEarthObject:
    ...
    def __str__(self):
        ...
        if self.hazardous == True :
            ...
            temp = 'is not'
        return (f"NEO {self.fullname} has a diameter of {self.diameter:.3f} km and {temp} potentially hazardous.")
...
class CloseApproach:
    ...
    # TODO: How can you, and should you, change the arguments to this constructor?
    # If you make changes, be sure to update the comments in this file.
    def __init__(self, _designation, time, distance = 0.0 , velocity = 0.0):
